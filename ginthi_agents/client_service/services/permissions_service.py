...
from client_service.schemas.pydantic_schemas import PermissionCreate, PermissionUpdate
...
class PermissionService:
    ...
    async def delete(permission_id: UUID, db: AsyncSession):
        ...
        try:
            ...
            return {"message": PermissionMessages.DELETED_SUCCESS.format(id=permission_id)}
