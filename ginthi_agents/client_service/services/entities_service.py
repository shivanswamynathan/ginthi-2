...
from client_service.schemas.pydantic_schemas import ClientEntityCreate, ClientEntityUpdate
...
class EntityService:
    ...
    async def delete(entity_id: UUID, db: AsyncSession):
        ...
        try:
            ...
            return {"message": EntityMessages.DELETED_SUCCESS.format(id=entity_id)}
